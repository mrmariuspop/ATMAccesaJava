...
public class ConsumeMessageResponseCode {
    ...
    public ConsumeMessageResponseCode() throws JMSException {
...
//        MessageConsumer consumer = session.createConsumer(session.createQueue("Testqueue"));
        MessageConsumer consumer = session.createConsumer(session.createQueue("responsecode"));
